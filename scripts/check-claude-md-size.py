...
#
# container/baked-CLAUDE.md: current size ~74,730 bytes (2026-06-19, after
# trimming verbose prose to fix PR #380 CI). Pinned just above current so it
# cannot grow. TODO: trim below HARD_LIMIT (40k) and delete this entry once
# it fits the generic budget.
ALLOWLIST: dict[str, int] = {
    "container/baked-CLAUDE.md": 74_900,
}
